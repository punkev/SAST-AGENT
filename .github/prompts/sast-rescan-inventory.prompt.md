...
5. Execute the `html-report-generator` Python skill (`python .agents/skills/html-report-generator/scripts/generate_html_report.py`) to refresh `.sast-agent/reports/index.html`.
